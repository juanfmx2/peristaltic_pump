...
var get_bottom_box, get_extruded_dove_tail_rails, get_heart_polygon, get_top_box, util;
...
get_top_box = function(params, box_width, box_height, clearance, heart_offset) {
  var ak_text, ayear_text, dovetail_rails, heart, heart_box, jf_text, jyear_text, top_box, top_height;
  ...
  top_box = difference(heart_box, dovetail_rails[0].translate([0, 0, -heart_offset]), dovetail_rails[1].translate([0, 0, -heart_offset])).translate([0, 0, box_height / 3]);
  ak_text = util.create_extruded_text('AK', 2 * params.heart_radius, 2, params.text_depth).rotateX(90).translate([box_width * 7 / 12, params.text_depth, box_height / 2]);
  jf_text = util.create_extruded_text('JF', 2 * params.heart_radius, 2, params.text_depth).rotateX(90).rotateZ(180).translate([box_width * 5 / 12, box_width - params.text_depth, box_height / 2]);
  ayear_text = util.create_extruded_text('86', 2 * params.heart_radius, 2, params.text_depth).rotateX(90).rotateZ(90).translate([box_width - params.text_depth, box_width * 1 / 12, box_height / 2]);
  jyear_text = util.create_extruded_text('89', 2 * params.heart_radius, 2, params.text_depth).rotateX(90).rotateZ(270).translate([params.text_depth, box_width * 11 / 12, box_height / 2]);
  top_box = difference(top_box, ak_text, jf_text, ayear_text, jyear_text);
  return color('yellow', top_box);
};
...
global.main = function(params) {
  var bottom_box, box_height, box_width, heart_offset, inner_hole, inner_hole_radius, parts_clearance, top_box;
